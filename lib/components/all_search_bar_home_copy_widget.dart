...
import 'all_search_bar_home_copy_model.dart';
export 'all_search_bar_home_copy_model.dart';

/// All travel service bar
class AllSearchBarHomeCopyWidget extends StatefulWidget {
  const AllSearchBarHomeCopyWidget({super.key});

  @override
  State<AllSearchBarHomeCopyWidget> createState() =>
      _AllSearchBarHomeCopyWidgetState();
}

class _AllSearchBarHomeCopyWidgetState extends State<AllSearchBarHomeCopyWidget>
    with TickerProviderStateMixin {
  late AllSearchBarHomeCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllSearchBarHomeCopyModel());
