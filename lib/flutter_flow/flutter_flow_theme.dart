...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0048A8);
  late Color secondary = const Color(0xFFE0171F);
  late Color tertiary = const Color(0xFFE57B7F);
  late Color alternate = const Color(0xFFAFBDCC);
  late Color primaryText = const Color(0xFF1E1E1F);
  late Color secondaryText = const Color(0xFF262627);
  late Color primaryBackground = const Color(0xFFF8F8F8);
  late Color secondaryBackground = const Color(0xFFF8F8FF);
  ...
  late Color mutedColor = const Color(0xFF8B8788);
  late Color darkMutedColor = const Color(0xFF3E4048);
}
