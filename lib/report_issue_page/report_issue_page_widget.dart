...
class ReportIssuePageWidget extends StatefulWidget {
  const ReportIssuePageWidget({super.key});

  static String routeName = 'ReportIssuePage';
  static String routePath = '/reportIssuePage';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'f3hjb6fq' /* Report an issue to us any time... */,
                          ),
                          style:
